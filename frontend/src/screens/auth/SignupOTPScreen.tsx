...
type RoutePropType = RouteProp<AuthStackParamList, 'SignupOTP'>;

export const SignupOTPScreen: React.FC = () => {
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            if (updateError) {
                ...
                // Even if password update fails, account is created - user can reset password later
            }
    ...
    const handleResend = async () => {
        setIsResending(true);
        try {
            // Resend OTP using Supabase's built-in method
